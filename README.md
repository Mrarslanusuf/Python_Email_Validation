...
# Build email validation System using Python | eTechmentor YouTube

In this GitHub repository, we're going to create create a email validation system using Python. In this email validation tool, the user will be required to enter their email address to check weather is valid email or not. This tool will tell the user it's given email is valid email or not.
...
Download this python file & Save into your folder

Open command prompt or vscode in this directory
...
| Command             | Description                                                                |
| ----------------- | ------------------------------------------------------------------ |
| python pyemail.py  | This command Run the execute the Python code on console  |
